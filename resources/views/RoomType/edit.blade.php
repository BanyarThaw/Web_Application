...
@section('sub_content')
    ...
    <br>
    <form action="/roomtype/{{ $room_type->id }}" method="post" enctype="multipart/form-data" class="user_form">
        {{ method_field("PATCH") }}
        {{ csrf_field() }}
        ...
        <div class="user_input_data">
            <div class="col-md-12 col-sm-12 col-xs-12" id="user_input_form">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <input type="text" name="room_type_name" value="{{ $room_type->name }}" required>
                </div>
            </div>
        </div>
