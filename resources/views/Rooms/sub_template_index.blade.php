...
@section('content')
    ...
    <div class="sub_menu col-md-3 col-sm-3">
        <div class="sub_menus sub_menus_active">
            <a href="/room" class="sub_menu_anchor_active">Room List</a>
        </div>
        <div class="sub_menus">
            <a href="/room/create" class="sub_menu_anchor">Create Room</a>
        </div>
        <div class="sub_menus">
            <a href="/roomtype" class="sub_menu_anchor">Room Type</a>
        </div>
    </div>
